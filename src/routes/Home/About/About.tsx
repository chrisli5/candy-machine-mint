...
import imageLaptop from "../../../images/about/pencil3.png";
import imagePencil from "../../../images/about/pencil3.png";
  ...
  <Section id="about" className="section--secondary">
    <Row>
      ...
      <Col xs={12} className="about__middle">
        <Row>
          <Col xs={12} md={3} className="about__image">
            <Image src={imageLaptop} fluid />
          </Col>
          <Col xs={12} md={9} className="about__text">
      ...
      <Col xs={12} className="about__bottom">
        <Row>
          <Col xs={12} md={3} className="about__image about__image--bottom">
